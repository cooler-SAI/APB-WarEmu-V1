...
namespace MapServer
{
    ...
    public class WorldEntityUpdate : ISerializablePacket
    {
        ...
        public void BuildInventory(RiftClient From, Character Char)
        {
            ...
            this.AddField(6, EPacketFieldType.Raw8Bytes, (long)Char.CharacterId);
            ...
            From.SendSerialized(WorldMgr.BuildCache(2007607340, 7310, Program.World.GetTemplate(2007607340)));
            From.SendSerialized(WorldMgr.BuildCache(935832306, 623, Program.World.GetData(935832306)));
        ...
        public void BuildItem(RiftClient From, Character Char)
        {
            ...
            From.SendSerialized(WorldMgr.BuildCache(506516265,7310,Program.World.GetTemplate(506516265)));
            From.SendSerialized(WorldMgr.BuildCache(456805300,623,Program.World.GetData(456805300)));
