...
protected:
	...
	__forceinline int32 event_GetCurrentInstanceId() { return m_event_Instanceid; }
...
public:
	...
	__forceinline bool event_HasEvents() { return m_events.size() > 0 ? true : false; }
...
public:
	...
	__forceinline uint32 GetInstanceID() { return mInstanceId; }
