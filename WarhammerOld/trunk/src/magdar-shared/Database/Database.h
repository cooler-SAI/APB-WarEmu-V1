...
public:
	...
	void Perform();
	__forceinline void SetDB(Database * dbb) { db = dbb; }
};
...
public:
	...
	__forceinline const string& GetHostName() { return mHostname; }
	__forceinline const string& GetDatabaseName() { return mDatabaseName; }
	__forceinline const uint32 GetQueueSize() { return queries_queue.get_size(); }
...
public:
	...
	__forceinline Field* Fetch() { return mCurrentRow; }
	__forceinline uint32 GetFieldCount() const { return mFieldCount; }
	__forceinline uint32 GetRowCount() const { return mRowCount; }
