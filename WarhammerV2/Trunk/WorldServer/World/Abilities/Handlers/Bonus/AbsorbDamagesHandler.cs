...
{
    [IAbilityType("AbsorbDamages", "Heal Target Handler")]
    public class AbsorbDamagesHandler : IAbilityTypeHandler
    {
        public Ability Ab;
        public Unit Target;
        ...
        public override GameData.AbilityResult CanCast(bool IsStart)
        {
            ...
            else if (!CombatInterface.IsFriend(Ab.Caster, Target))
        ...
        public override IAbilityTypeHandler Cast()
        {
            ...
            if (Ab.Info.GetTime(0) != 0)
                return Target.AbtInterface.AddBuff(Ab, "AbsorbDamagesOverTime");
